...
const (
	...
	MYSQL_FIELD_TYPE_DECIMAL    = 8    // DECIMAL
	MYSQL_FIELD_TYPE_DATE       = 9    // DATE
	MYSQL_FIELD_TYPE_DATETIME   = 10   // DATETIME
	MYSQL_FIELD_TYPE_TIMESTAMP  = 11   // TIMESTAMP
	MYSQL_FIELD_TYPE_TIME       = 12   // TIME
	MYSQL_FIELD_TYPE_YEAR       = 13   // YEAR
	MYSQL_FIELD_TYPE_CHAR       = 14   // CHAR
	MYSQL_FIELD_TYPE_VARCHAR    = 15   // VARCHAR
	MYSQL_FIELD_TYPE_BINARY     = 16   // BINARY
	MYSQL_FIELD_TYPE_VARBINARY  = 17   // VARBINARY
	MYSQL_FIELD_TYPE_TINYBLOB   = 18   // TINYBLOB
	MYSQL_FIELD_TYPE_TINYTEXT   = 19   // TINYTEXT
	MYSQL_FIELD_TYPE_BLOB       = 20   // BLOB
	MYSQL_FIELD_TYPE_TEXT       = 21   // TEXT
	MYSQL_FIELD_TYPE_MEDIUMBLOB = 22   // MEDIUMBLOB
	MYSQL_FIELD_TYPE_MEDIUMTEXT = 23   // MEDIUMTEXT
	MYSQL_FIELD_TYPE_LONGBLOB   = 24   // LONGBLOB
	MYSQL_FIELD_TYPE_LONGTEXT   = 25   // LONGTEXT
	MYSQL_FIELD_TYPE_ENUM       = 26   // ENUM
	MYSQL_FIELD_TYPE_SET        = 27   // SET
...
var mysql_field_type_string_map = map[int]string{
	...
	MYSQL_FIELD_TYPE_DECIMAL:    "DECIMAL",
...
var mysql_field_string_type_map = map[string]int{
	...
	"DECIMAL":    MYSQL_FIELD_TYPE_DECIMAL,
...
const (
	...
	MYSQL_FIELD_DEFAULT_LENGTH_DECIMAL    = 38
...
var mysql_field_type_default_length_map = map[int]int{
	...
	MYSQL_FIELD_TYPE_DECIMAL:    MYSQL_FIELD_DEFAULT_LENGTH_DECIMAL,
...
var mysql_field_type_string_maps = map[int]string{
	...
	MYSQL_FIELD_TYPE_DECIMAL:    "float64",
	MYSQL_FIELD_TYPE_DATE:       "",
	MYSQL_FIELD_TYPE_DATETIME:   "",
	MYSQL_FIELD_TYPE_TIMESTAMP:  "",
	MYSQL_FIELD_TYPE_TIME:       "",
